    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }} edges={['top', 'left', 'right']}>
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          />
          <TouchableOpacity
            onPress={() => Alert.alert('Pronunciation Mode', 'Press and hold the button to record yourself speaking. I\'ll analyse your pronunciation and give you accent feedback.')}
