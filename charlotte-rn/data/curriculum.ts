    ...
    topics: [
      {
        ...
        grammar: [
          // mc × 2
          { type: 'multiple_choice', sentence: '_____ to meet you!',                       answer: 'Nice',       options: ['Nice', 'Good', 'Happy'],            explanation: '"Nice to meet you" is the standard English greeting when meeting someone for the first time.' },
          { type: 'multiple_choice', sentence: 'How _____ you today?',                     answer: 'are',        options: ['are', 'is', 'am'],                  explanation: '"How are you?" uses "are" because the subject is "you" (second person).' },
          // wb × 2
          { type: 'word_bank', sentence: 'Good _____, everyone!',                          answer: 'morning',    choices: ['morning', 'night', 'noon', 'lunch'], explanation: '"Good morning" is used as a greeting in the early part of the day.' },
          { type: 'word_bank', sentence: 'See you _____!',                                 answer: 'later',      choices: ['later', 'soon', 'after', 'next'],    explanation: '"See you later" is a common informal farewell phrase.' },
          // fill × 3
          { type: 'fill_gap', sentence: 'A: How are you? B: I\'m fine, _____.',            answer: 'thank you',  hint: 'A polite response after "I\'m fine"',    explanation: '"I\'m fine, thank you" is the standard polite response to "How are you?".' },
          { type: 'fill_gap', sentence: '_____ morning! How are you?',                     answer: 'Good',       hint: 'Greeting in the morning',               explanation: '"Good morning" is the greeting used from early morning until midday.' },
          { type: 'fill_gap', sentence: 'A: Goodbye! B: _____ you later!',                 answer: 'See',        hint: 'Common informal farewell',               explanation: '"See you later" is a common informal way to say goodbye.' },
          // fix × 2
          { type: 'fix_error', sentence: 'Good meet you!',                                 answer: 'Nice to meet you!',     hint: 'Standard first-meeting phrase', explanation: 'The correct phrase is "Nice to meet you!" — "Good meet you" is not English.' },
          { type: 'fix_error', sentence: 'How you are?',                                   answer: 'How are you?',          hint: 'Question word order',           explanation: 'In English questions, the auxiliary verb comes before the subject: "How are you?"' },
          // read × 1
          { type: 'read_answer', passage: 'Tom walks into the office. He sees his colleague Ana and says "Good morning!" Ana smiles and replies "Good morning! How are you?" Tom answers "I\'m great, thanks!"', question: 'How does Tom feel?', answer: 'great', explanation: 'Tom answers "I\'m great, thanks!" which tells us how he feels.' },
        ],
      },
      {
        ...
        pronunciation: [],
        grammar: [
          { type: 'multiple_choice', sentence: '_____ am a student.',                      answer: 'I',          options: ['I', 'He', 'We'],                    explanation: '"Am" is only used with the first person singular pronoun "I".' },
          { type: 'multiple_choice', sentence: 'She _____ my teacher.',                    answer: 'is',         options: ['is', 'am', 'are'],                  explanation: '"Is" is used with third person singular (he, she, it).' },
          { type: 'word_bank', sentence: 'They _____ from Brazil.',                        answer: 'are',        choices: ['are', 'is', 'am', 'be'],            explanation: '"Are" is used with plural subjects (they, we, you).' },
          { type: 'word_bank', sentence: 'He _____ a doctor.',                             answer: 'is',         choices: ['is', 'are', 'am', 'be'],            explanation: '"Is" is used with third person singular subjects (he, she, it).' },
          { type: 'fill_gap', sentence: 'I _____ 25 years old.',                           answer: 'am',         hint: 'To be with "I"',                        explanation: '"Am" is the form of "to be" used with "I".' },
          { type: 'fill_gap', sentence: 'You _____ very kind.',                            answer: 'are',        hint: 'To be with "you"',                      explanation: '"Are" is the form of "to be" used with "you".' },
          { type: 'fill_gap', sentence: 'We _____ friends.',                               answer: 'are',        hint: 'To be with "we"',                       explanation: '"Are" is used with "we", "you", and "they".' },
          { type: 'fix_error', sentence: 'He am a student.',                               answer: 'He is a student.',              hint: 'Subject-verb agreement with he', explanation: '"He" requires "is", not "am". Only "I" uses "am".' },
          { type: 'fix_error', sentence: 'They is from Japan.',                            answer: 'They are from Japan.',          hint: 'Subject-verb agreement with they', explanation: '"They" requires "are", not "is".' },
          { type: 'read_answer', passage: 'My name is Sofia. I am 22 years old. I am from Portugal. My brother is Carlos. He is 25. We are both students.', question: 'How old is Carlos?', answer: '25', explanation: 'The passage says "He is 25" referring to Carlos.' },
        ],
      },
      {
        ...
        pronunciation: [],
        grammar: [
          { type: 'multiple_choice', sentence: 'I _____ tired today.',                     answer: "am not",     options: ["am not", "is not", "are not"],       explanation: '"Am not" is the negative form of "to be" with "I". There is no contraction "amn\'t" in standard English.' },
          { type: 'multiple_choice', sentence: 'A: Are you hungry? B: No, I ___.',         answer: "am not",     options: ["am not", "isn't", "aren't"],         explanation: 'Short negative answer for "Are you...?" is "No, I\'m not" or "No, I am not".' },
          { type: 'word_bank', sentence: 'She _____ at home right now.',                   answer: "isn't",      choices: ["isn't", "aren't", "am not", "not is"], explanation: '"Isn\'t" = "is not" — used with he/she/it in the negative.' },
          { type: 'word_bank', sentence: 'We _____ ready yet.',                            answer: "aren't",     choices: ["aren't", "isn't", "am not", "not are"], explanation: '"Aren\'t" = "are not" — used with we/you/they in the negative.' },
          { type: 'fill_gap', sentence: 'He _____ (not) happy about the result.',          answer: "isn't",      hint: 'Contracted negative with he',            explanation: '"Isn\'t" is the contracted form of "is not", used with he/she/it.' },
          { type: 'fill_gap', sentence: 'A: Is she a nurse? B: No, she ___.',              answer: "isn't",      hint: 'Short negative answer for "Is she?"',   explanation: 'Short negative answer: "No, she isn\'t" (or "No, she\'s not").' },
          { type: 'fill_gap', sentence: 'They _____ (not) from the United States.',        answer: "aren't",     hint: 'Contracted negative with they',          explanation: '"Aren\'t" = "are not" — for we/you/they negatives.' },
          { type: 'fix_error', sentence: 'I amn\'t a teacher.',                            answer: "I'm not a teacher.",            hint: 'No "amn\'t" in English',        explanation: 'There is no "amn\'t" in English. The correct negative is "I\'m not" or "I am not".' },
          { type: 'fix_error', sentence: 'She not is my sister.',                          answer: "She isn't my sister.",          hint: 'Word order in negative',        explanation: 'In negatives, "not" comes after the verb "to be": "She is not" → "She isn\'t".' },
          { type: 'read_answer', passage: 'Marco is Italian but he isn\'t from Rome. He\'s from Milan. His parents aren\'t in Italy anymore — they are in Canada now.', question: "Where are Marco's parents now?", answer: 'Canada', explanation: 'The passage says "they are in Canada now".' },
        ],
      },
      {
        ...
        pronunciation: [],
        grammar: [
          { type: 'multiple_choice', sentence: '_____ she your sister?',                   answer: 'Is',         options: ['Is', 'Are', 'Am'],                  explanation: 'Questions with he/she/it use "Is" at the start: "Is she...?"' },
          { type: 'multiple_choice', sentence: '_____ you from Brazil?',                   answer: 'Are',        options: ['Are', 'Is', 'Am'],                  explanation: 'Questions with you/we/they use "Are": "Are you...?"' },
          { type: 'word_bank', sentence: '_____ they students?',                           answer: 'Are',        choices: ['Are', 'Is', 'Am', 'Be'],            explanation: '"Are" is used in questions with "they".' },
          { type: 'word_bank', sentence: '_____ he at work today?',                        answer: 'Is',         choices: ['Is', 'Are', 'Am', 'Be'],            explanation: '"Is" is used in questions with "he".' },
          { type: 'fill_gap', sentence: '_____ I late for the meeting?',                   answer: 'Am',         hint: 'Question with "I"',                     explanation: '"Am" is used in questions with "I": "Am I late?"' },
          { type: 'fill_gap', sentence: '_____ you ready to start?',                       answer: 'Are',        hint: 'Question with "you"',                   explanation: '"Are" is used in questions with "you".' },
          { type: 'fill_gap', sentence: 'A: _____ she a doctor? B: Yes, she is.',          answer: 'Is',         hint: 'Question with "she"',                   explanation: '"Is" begins yes/no questions with she/he/it.' },
          { type: 'fix_error', sentence: 'Are she your teacher?',                          answer: 'Is she your teacher?',          hint: '"She" takes "is" not "are"',    explanation: '"She" requires "Is" in questions, not "Are".' },
          { type: 'fix_error', sentence: 'Is you happy?',                                  answer: 'Are you happy?',               hint: '"You" takes "are" not "is"',    explanation: '"You" requires "Are" in questions, not "Is".' },
          { type: 'read_answer', passage: '"Is this your bag?" asked the security guard. "No, it isn\'t," said the woman. "Are these your keys?" "Yes, they are! Thank you!"', question: 'Are the keys hers?', answer: 'yes', explanation: 'She answers "Yes, they are!" confirming the keys are hers.' },
        ],
      },
    ],
  },
