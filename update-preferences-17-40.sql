-- 🔧 ATUALIZAR PREFERENCES PARA 17:40 - Execute no SQL Editor do Supabase Dashboard

-- 1. ATUALIZAR PREFERÊNCIAS PARA 17:40 (TESTE)
UPDATE users 
SET preferred_reminder_time = '17:40:00'
WHERE entra_id IN (
