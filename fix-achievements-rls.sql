...
-- Usuários podem ver seus próprios achievements
...
-- Usuários podem inserir seus próprios achievements
...
-- Usuários podem atualizar seus próprios achievements
...
DO $$
BEGIN
  RAISE NOTICE '✅ RLS policies updated for user_achievements';
