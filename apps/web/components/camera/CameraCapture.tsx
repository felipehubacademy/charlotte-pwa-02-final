...
const CameraCapture: React.FC<CameraCaptureProps> = ({
  ...
  const getInstructionText = () => {
    if (userLevel === 'Novice') {
      return 'Centralize o objeto que a Charlotte te dirá o que é';
    }
    return 'Center the object and Charlotte will tell you what it is';
  };

  // Handle camera capture - opens native camera directly
        ...
        >
          ...
          <div className="flex-1 relative overflow-hidden">
            {capturedImage ? (
              ...
              /* Camera Interface - No Video Stream */
              <div className="relative w-full h-full flex flex-col items-center justify-center bg-gray-900">
                <div className="text-center z-10 px-8">
                  <div className="w-32 h-32 border-2 border-white/30 rounded-lg mx-auto flex items-center justify-center mb-8">
          ...
          {/* Hidden file input for camera - PHOTO ONLY */}
          <input
            ref={fileInputRef}
            type="file"
            accept="image/*"
